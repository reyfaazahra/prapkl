                            ...
                            <div class="sidebar__menu">
                                <ul>
                                    ...
                                    @foreach ($category as $dataa)
                                        <li>
                                            <a href="{{ route('product.filter', $dataa->slug) }}"
                                                class="{{ isset($selectedCategory) && $selectedCategory->id == $dataa->id ? 'fw-bold text-primary' : '' }}">
                                                {{ $dataa->name }} <span>({{ $dataa->product->count() }})</span>
                                            </a>
